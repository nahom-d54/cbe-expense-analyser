...
from utils.helper_functions import extract_from_sms
        ...
        try:
            ...
            if results and results.get("transaction_amount"):
                ...
                transaction_amount = float(
                    results["transaction_amount"].replace(",", "")
                )
                ...
                if direction == "incoming":
                    print(
                        f"Incoming transaction of {transaction_amount} ETB received from {results.get('payer', 'Unknown')}"
                    )
                else:
                    print(
                        f"Outgoing transaction of {transaction_amount} ETB to {results.get('receiver', 'Unknown')}"
                    )
...
def main():
    ...
    print(
        "Analysis complete! Check transaction_analysis_report.pdf for the detailed report."
    )
